...
def safeFeet():
    ...
    # Get the block directly below your player: getBlock() will get the block id of the block at the coordinates you provide. Because pos.x, pos.y and pos.z
    # are the coordinates of your player, you must use pos.y-1 to get the block directly below Steve's feet:
